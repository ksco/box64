...
#undef GO
        ...
        case 0x58:
            ...
            if (!BOX64ENV(dynarec_fastnan)) {
                ...
                VFCMP_D(v0, q1, q0, cUN);
                VFCMP_D(d0, q1, q1, cUN);
                VLDI(d1, (0b011 << 10) | 0b0000001000);
                VSLLI_D(d1, d1, 48);
                VOR_V(d1, q1, d1);
            }
            VFADD_D(q1, q1, q0);
            if (!BOX64ENV(dynarec_fastnan)) {
                ...
                VANDN_V(v0, v0, v1);
                VLDI(v1, (0b011 << 10) | 0b1111111000);
                VSLLI_D(v1, v1, 48);
                VBITSEL_V(q1, q1, v1, v0);
            }
            break;
        case 0x59:
        ...
        case 0xA3:
            ...
            if (MODREG) {
                ...
                EXT_W_H(x1, gd);
                SRAI_D(x1, x1, 4);
                ALSL_D(x3, x1, wback, 1);
                LD_H(x1, x3, fixedaddress);
                ed = x1;
            }
            IFX (X_CF) {
                ANDI(x2, gd, 0xf);
        ...
        case 0xD0:
            ...
            if (!BOX64ENV(dynarec_fastnan)) {
                ...
                VFCMP_D(d0, q0, q1, cUN);
                VFCMP_D(d1, q0, q0, cUN);
                VLDI(d2, (0b011 << 10) | 0b0000001000);
                VSLLI_D(d2, d2, 48);
                VOR_V(d2, q0, d2);
            }
            v0 = fpu_get_scratch(dyn);
            ...
            if (!BOX64ENV(dynarec_fastnan)) {
                ...
                VANDN_V(d0, d0, d2);
                VLDI(d2, (0b011 << 10) | 0b1111111000);
                VSLLI_D(d2, d2, 48);
                VBITSEL_V(q0, q0, d2, d0);
            }
            break;
        case 0xD1:
