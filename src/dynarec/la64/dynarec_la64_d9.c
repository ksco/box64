...
uintptr_t dynarec64_D9(dynarec_la64_t* dyn, uintptr_t addr, uintptr_t ip, int ninst, rex_t rex, int rep, int* ok, int* need_epilog)
{
    ...
    switch (nextop) {
        ...
        case 0xF2:
            ...
            x87_forget(dyn, ninst, x1, x2, 0);
            s0 = x87_stackcount(dyn, ninst, x3);
            if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x4, x5);
            CALL_2(native_ftan, -1, BOX64ENV(dynarec_fastround) ? 0 : u8, 0, 0);
        ...
        case 0xF3:
            ...
            s0 = x87_stackcount(dyn, ninst, x3);
            if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x4, x5);
            CALL_2(native_fpatan, -1, BOX64ENV(dynarec_fastround) ? 0 : u8, 0, 0);
            if (!BOX64ENV(dynarec_fastround)) x87_restoreround(dyn, ninst, u8);
            x87_unstackcount(dyn, ninst, x3, s0);
            X87_POP_OR_FAIL(dyn, ninst, x3);
            break;
        ...
        case 0xFB:
            ...
            s0 = x87_stackcount(dyn, ninst, x3);
            if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x4, x5);
            CALL_2(native_fsincos, -1, BOX64ENV(dynarec_fastround) ? 0 : u8, 0, 0);
            if (!BOX64ENV(dynarec_fastround)) x87_restoreround(dyn, ninst, u8);
            x87_unstackcount(dyn, ninst, x3, s0);
            break;
        case 0xFC:
            ...
            u8 = x87_setround(dyn, ninst, x3, x4);
        ...
        case 0xFD:
            ...
            s0 = x87_stackcount(dyn, ninst, x3);
            if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x4, x5);
            CALL_2(native_fscale, -1, BOX64ENV(dynarec_fastround) ? 0 : u8, 0, 0);
            if (!BOX64ENV(dynarec_fastround)) x87_restoreround(dyn, ninst, u8);
            x87_unstackcount(dyn, ninst, x3, s0);
            break;
        case 0xFE:
            ...
            s0 = x87_stackcount(dyn, ninst, x3);
            if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x4, x5);
            CALL_2(native_fsin, -1, BOX64ENV(dynarec_fastround) ? 0 : u8, 0, 0);
            if (!BOX64ENV(dynarec_fastround)) x87_restoreround(dyn, ninst, u8);
            x87_unstackcount(dyn, ninst, x3, s0);
            break;
        case 0xFF:
            ...
            s0 = x87_stackcount(dyn, ninst, x3);
            if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x4, x5);
            CALL_2(native_fcos, -1, BOX64ENV(dynarec_fastround) ? 0 : u8, 0, 0);
            if (!BOX64ENV(dynarec_fastround)) x87_restoreround(dyn, ninst, u8);
            x87_unstackcount(dyn, ninst, x3, s0);
            break;
        ...
        default:
            switch ((nextop >> 3) & 7) {
                case 0:
                    ...
                    X87_PUSH_OR_FAIL(v1, dyn, ninst, x1, BOX64ENV(dynarec_x87double) ? LSX_CACHE_ST_D : LSX_CACHE_ST_F);
                ...
                case 2:
                    ...
                    if (ST_IS_F(0))
                        ...
                        if (!BOX64ENV(dynarec_fastround)) u8 = x87_setround(dyn, ninst, x3, x4);
                        FCVT_S_D(s0, v1);
                        if (!BOX64ENV(dynarec_fastround)) x87_restoreround(dyn, ninst, u8);
                    }
                    addr = geted(dyn, addr, ninst, nextop, &ed, x2, x1, &fixedaddress, rex, NULL, 1, 0);
