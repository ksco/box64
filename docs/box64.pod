...
=item B<BOX64_DYNAREC_CALLRET> =I<0|1|2|3>
...
=item B<BOX64_DYNAREC_SEP> =I<0|1|2>
...
=item B<BOX64_DYNAREC_DUMP> =I<0|1|2|3>
...
=item B<BOX64_DYNAREC_DISASM> =I<0|1>
...
=item B<BOX64_DYNAREC_FORWARD> =I<0|128|256|512|1024>
...
=item B<BOX64_DYNAREC_NOHOSTEXT> =I<0|1|xxx,yyy,zzz>
...
=item B<BOX64_DYNAREC_STRONGMEM> =I<0|1|2|3|4>
...
=item B<BOX64_DYNAREC_TEST_NODUP> =I<0|1>
...
=item B<BOX64_DYNAREC_TEST_NODUMP> =I<0|1>
...
=item B<BOX64_DYNACACHE_LIMIT> =I<0|XXXX|2048>
...
=item B<BOX64_DYNACACHE_COMPRESS> =I<0|1|2>
...
=item B<BOX64_DYNACACHE_MIN> =I<XXXX|30>
...
=item B<BOX64_NODYNAREC_DELAY> =I<0|1>
...
=item B<BOX64_DYNAREC_NOARCH> =I<0|1|2>
...
=item B<BOX64_NOVULKANOVERLAY> =I<0|1>
...
=item B<BOX64_ONDEMAND_STEAMUI> =I<0|1>
...
=item B<BOX64_PROFILE> =I<safest|safe|default|fast|fastest>
...
=item B<BOX64_STEAM_VULKAN> =I<0|1>
...
=item B<BOX64_TRACE_FILE> =I<XXXX|XXXX%pid|stderr|stdout>
...
=item B<BOX64_TRACE_INIT> =I<0|1|symbolname|0xXXXXXXX-0xYYYYYYY|0xXXXXXXX:0xYYYYYYY:0xZZZZZZZ>
...
=item B<BOX64_TRACE> =I<0|1|symbolname|0xXXXXXXX-0xYYYYYYY|0xXXXXXXX:0xYYYYYYY:0xZZZZZZZ>
...
=item B<BOX64_NOPERSONA32BITS> =I<0|1>
